...
import kunal.springframework.recipe.services.IngredientService;
import kunal.springframework.recipe.services.RecipeService;
import kunal.springframework.recipe.services.UnitOfMeasureService;
...
public class IngredientController {
    ...
    public String deleteIngredient(@PathVariable String recipeId,@PathVariable String id){
        log.debug("deleting ingredient is:"+id);
        String s;
